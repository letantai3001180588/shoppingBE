...
app.post('/detailBill/create', (req, res) => {
  ...
  //   acount.find({_id:verify._id}).then((data)=>{
        ...
        const a=[req.body,req.body]
          detailBill.insertMany([
            {
              id_product:Schema.Types.ObjectId('63fb1918f07b3195bad1c46a'),
              id_bill:Schema.Types.ObjectId('63fb1918f07b3195bad1c46a'),
              quantity:2
            },
            {
              id_product:Schema.Types.ObjectId('63fb1918f07b3195bad1c46m'),
              id_bill:Schema.Types.ObjectId('63fb1918f07b3195bad1c46n'),
              quantity:5
            }
          ])
