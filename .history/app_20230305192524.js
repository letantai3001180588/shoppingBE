...
app.post('/detailBill/create', (req, res) => {
  ...
  //   acount.find({_id:verify._id}).then((data)=>{
        ...
        // const detailBill=mongoose.model('detailBill',detailBillSchema)
        // const a=new detailBill(req.body)
        // a.save()
  ...
  // res.send(req.body)
  const ab=mongoose.model('detailBill',detailBillSchema)
  const product=new ab({
    id_product:Schema.Types.ObjectId(req.body.id_product),
    id_bill:Schema.Types.ObjectId(req.body.id_bill),
    quantity:req.body.quantity, 
  })
  product.save().then(()=>res.send(req.body))
  .catch(()=>res.send('loi server'))
