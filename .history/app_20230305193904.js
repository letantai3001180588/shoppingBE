...
app.post('/detailBill/create', (req, res) => {
  ...
  //   acount.find({_id:verify._id}).then((data)=>{
        ...
        detailBill.insertMany([
          {
            id_product:Schema.Types.ObjectId('63fb17eaf07b3195bad1c46a'),
            id_bill:Schema.Types.ObjectId('63fb17eaf07b3195bad1c46a'),
            quantity:2
          },
          {
            id_product:Schema.Types.ObjectId('63fb17eaf07b3195bad1c46b'),
            id_bill:Schema.Types.ObjectId('63fb17eaf07b3195bad1c46b'),
            quantity:6
          }
        ])
